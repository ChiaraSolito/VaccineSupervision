...
\newpage
    ...
    Si è divisa la fase di test in 4 fasi principali:
        ...
        \subsubsection*{Nota}
        Al termine delle Unit Test definiamo ora l'applicazione come la \textbf{realease 1.0}, "rilasciata" in data 24/06/2021. Questa verrà sottoposta ai test di release.
    ...
    \newpage
        ...
        In questo modo si sono testate tutte le combinazioni di inserimento dei report da parte dei dottori. Alla fine dei test è stato somministrato un questionario, in cui si è chiesto di valutare (positivamente o negativamente) le diverse funzionalità testate nella parte "Dottore".\footnote{Si veda l'appendice C: Questionari}
            \begin{itemize}
                \item Il terzo tester ha fatto le veci di un nuovo utente Farmacologo, con tutti gli avvisi generati ancora da leggere e una fase di controllo da proporre. {Si veda l'appendice B, alla sezione "Passi che si richiede di effettuare, nella sezione farmacologo}
            \end{itemize}
...
\newpage
    ...
    \newpage
    \section*{Appendice B: Documento per i tester Dottore}
