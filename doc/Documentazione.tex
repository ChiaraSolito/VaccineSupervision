...
\newpage
    ...
    \subsubsection*{Chiamate della View del ReportForm}
        \begin{center}
            \includegraphics[width=1\textwidth]{pictures/Report1.png}
        \captionof{figure}{}
        \end{center}
    \newpage
    \begin{center}
        \includegraphics[width=1\textwidth]{pictures/Report2.png}
    \captionof{figure}{}
    \end{center}
    \newpage
    \begin{center}
        \includegraphics[width=1\textwidth]{pictures/Report3.png}
    \captionof{figure}{}
    \end{center}
    \newpage
    \subsubsection*{Chiamate della View del ControlPhaseForm}
    \begin{center}
