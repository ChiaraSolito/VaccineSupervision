...
\newpage
    ...
    Si è divisa la fase di test in 4 fasi principali:
        ...
        Per la parte di Test di sviluppo si è scelto di implementare degli Unit Test sulle classi del \textbf{Controller}. Questa scelta è derivata dal fatto che il controller rappresenta l'interazione tra l'interfaccia (testabile a livello visuale) e le DAO (le cui funzioni sono utilizzate dai controller e quindi implicitamente testate.)\\
            ...
            \end{itemize}
        Tutte le classi di test hanno ottenuto un buon risultato, i metodi per cui sono stati rilevati errori (ad esempio non stampavano il messaggio esatto) sono state ricontrollati e corretti. Ogni test è visibile nella sezione apposita dell'eseguibile.\\ Notiamo inoltre Runnando i test con Covarage,che abbiamo ottenuto il 100\% di coverage sulle classi testate.
    ...
    \newpage
        ...
        Al termine degli Stress Test definiamo ora l'applicazione come la \textbf{release 2.0}
    \newpage
    ...
    \paragraph*{Considerazioni dei tester}
        \begin{itemize}
            \item Bisognerebbe cambiare il tipo di data (che al momento è mostrata all'americana).
            \item Nella sezione dei fattori di rischio non si legge il bottone di selezione. 
            \item Durante il test è stato incontrato un bug riguardante l'inserimento di vaccinazioni antinfluenzali, quindi si è fixato. 
            \item Inserire l'indicazione che il livello di rischio o gravità è da 1 a 5.
            \item La scelta di avere un tab pane per l'inserimento del report è un po' fuorviante.\footnote{Gli sviluppatori hanno scelto di tenere comunque le tab pane (perché di nostro gradimento).}
        \end{itemize}
...
\newpage
    ...
    \paragraph*{Tabelle dello schema VaccineSupervisionDB}
        ...
        CREATE TABLE ReadNotice(
            noticeid INTEGER NOT NULL REFERENCES notice(id),
            pharmid VARCHAR(20) NOT NULL REFERENCES users(username),
            PRIMARY KEY(noticeid, pharmid)
        );
        \end{verbatim}
        ...
        \subsection*{Passi che si richiede di effettuare}
            ...
            \begin{enumerate}
                ...
                \item Inserire nei campi di testo:\\
                        Sito della vaccinazione: \textit{Varenna}, Data della vaccinazione: \textit{4 Dicembre 2021}
                ...
                \item Inserire nei campi di testo:\\
                    Sito della vaccinazione: \textit{Varenna}, Data della vaccinazione: \textit{16 Febbraio 2022}
                \item Cliccare su inserisci.
                ...
                \item Inserire nei campi di testo:\\
                    Sito della vaccinazione: \textit{Lecco}, Data della vaccinazione: \textit{30 Aprile 2022}
                \item Cliccare su inserisci.
                ...
                \item Inserire nei campi di testo:\\
                    Sito della vaccinazione: \textit{Varenna}, Data della vaccinazione: \textit{3 Giugno 2022}
                \item Cliccare su conferma.
            ...
            \begin{enumerate}
                ...
                \item Passare alla tab successiva e inserire come data reazione, dall'apposito calendario il \textit{30 Maggio 2022}.
                ...
                \item Inserire nei campi di testo:\\
                        Sito della vaccinazione: \textit{Salerno}, Data della vaccinazione: \textit{16 Aprile 2022}
                \item Cliccare su inserisci.
                ...
                \item Inserire nei campi di testo:\\
                    Sito della vaccinazione: \textit{Salerno}, Data della vaccinazione: \textit{20 Maggio 2022}
                \item Cliccare su inserisci.
                \item Cliccare su conferma.
                \item Apparirà ora un avviso di conferma, cliccare su OK.
                \item Si tornerà sutomaticamente nella pagina iniziale. 
    ...
    \begin{center}
        \includegraphics[width=1\textwidth]{pictures/doc1.png}
    \end{center}
    \newpage
    \begin{center}
        \includegraphics[width=1\textwidth]{pictures/doc2.png}
    \end{center}
    \newpage
    \begin{center}
        \includegraphics[width=1\textwidth]{pictures/farm.png}
    \end{center}
\end{document}